  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="<?=URLROOT?>home"><h2>Sixteen <em>Clothing</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link btn btn-danger" href="<?=URLROOT?>Users/logout">Logout <i class="bi bi-box-arrow-right"></i></a>
              </li>
            </ul>
          </div>
        </div>
