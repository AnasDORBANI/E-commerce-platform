                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="cart mt-4 align-items-center">
                                                        <a class="btn rounded-0 btn-danger text-uppercase mr-2 px-4"><i
                                                                class="bi bi-wallet-fill"></i> Buy
                                                            Now </a>
                                                        <a class="btn rounded-0 btn-outline-danger text-uppercase mr-2 px-4"
                                                            href="'.URLROOT.'home/removeFromCart/'.$product[0].'"><i
