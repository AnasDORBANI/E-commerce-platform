                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="cart mt-4 align-items-center">
                                <a class="btn btn-danger rounded-0 text-uppercase mr-2 px-4" dhref="<?=URLROOT?>"><i
                                        class=" bi bi-wallet-fill"></i> Buy Now </a>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="cart mt-4 align-items-center">
                                <button class="btn btn-danger text-uppercase mr-2 px-4"><i
                                        class="bi bi-wallet-fill"></i> Buy
                                    Now </button>
                                <button class="btn btn-outline-danger text-uppercase mr-2 px-4"
                                    href="<?=URLROOT?>home/addToCart/'.$product[0].'"><i
